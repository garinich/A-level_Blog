...
{
    public class CustomInitializer : DropCreateDatabaseAlways<BlogContext>
    {
        protected override void Seed(BlogContext context)
        {
            ...
            var author1 = new Author { Name = "John Tolkien"};
            author1.Articles.Add(articles[0]);
            author1.Articles.Add(articles[3]);

            var author2 = new Author { Name = "Lev Tolstoy"};
            author2.Articles.Add(articles[2]);

            var author3 = new Author { Name = "Alan Dean Foster"};
            author3.Articles.Add(articles[1]);

            context.Articles.AddRange(articles);
            context.Authors.AddRange(new Author[] {author1, author2, author3});
